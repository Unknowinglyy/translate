...
stepper1.set_speed(1000000)
stepper2.set_speed(1000000)
stepper3.set_speed(1000000)

stepper1.set_max_speed(1000000)
stepper2.set_max_speed(1000000)
stepper3.set_max_speed(1000000)
